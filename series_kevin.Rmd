...
CV_error_rega <- function(train, val, reg, fixed_params, test = FALSE){
  ...
  if(test){
    ...
    mod_pred <- series(m, "forecast.forecasts")[1:12]
...
Observamos que el modelo regArima no ofrece mejoras respecto al ets.
Si realizamos un plot comparando las predicciones de los 3